...
Forma, Descripción                     
`(let [v1 e1 ...] body...)`, Ligaduras locales     
`(if cond then else)`, Condicional         
`(fn [params...] body...)`, Funciones anónimas            
`(defn name [params...] body...)`, Definición de funciones       
`(sample dist)`, Muestreo de prior      
`(observe dist value)`, Condicionamiento       
`(primitive args...)`, Llamadas primitivas    
